...
class C2GANModel(BaseModel):
    ...
    def set_input(self, input):
        ...
        self.input_C=input_D
        self.input_D=input_C
    ...
    def backward_G(self):
        ...
        loss_G_VGG = 0
        self.loss_G_VGG = self.criterionVGG(self.fake_B, self.real_B) * 10 + self.criterionVGG(self.recovered_A, self.real_A) * 10

        # total      
        self.loss_G = self.loss_G_GAN + self.loss_G_L1 + self.loss_G_cyc + self.loss_G_VGG
    ...
    def get_current_errors(self):
        return OrderedDict([('G_GAN', self.loss_G_GAN.data[0]), ('G_L1', self.loss_G_L1.data[0]),
            ('G_Cyc', self.loss_G_cyc.data[0]), ('G_vgg', self.loss_G_VGG.data[0]), ('G_Total', self.loss_G.data[0]), ('D_real', self.loss_D_real.data[0]), 
