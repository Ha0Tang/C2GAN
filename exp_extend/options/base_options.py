...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataroot', type=str, default='./datasets/jaffe_neutral2disgust',
        ...
        self.parser.add_argument('--name', type=str, default='jaffe_neutral2disgust_pix2pix',
